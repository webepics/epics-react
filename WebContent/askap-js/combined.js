...
var BaseWidget = function (_React$Component) {
	...
	function BaseWidget() {
		...
		return _possibleConstructorReturn(this, (BaseWidget.__proto__ || Object.getPrototypeOf(BaseWidget)).call(this));
	}
	...
	_createClass(BaseWidget, [{
		...
		value: function componentWillMount() {
			...
			this.subId = wsManager.subscribe(this.props.pv, function (message) {
				return _this2.processUpdate(message);
			});
		}
	}, {
...
var ListBaseWidget = function (_React$Component) {
	_inherits(ListBaseWidget, _React$Component);

	function ListBaseWidget() {
		_classCallCheck(this, ListBaseWidget);

		var _this = _possibleConstructorReturn(this, (ListBaseWidget.__proto__ || Object.getPrototypeOf(ListBaseWidget)).call(this));

		_this.subIdList = new Map();
		return _this;
	}

	_createClass(ListBaseWidget, [{
		key: 'componentWillMount',
		value: function componentWillMount() {
			var _this2 = this;
			...
			for (var i = 0; i < this.props.pv.length; i++) {
				for (var j = 0; j < this.props.pv[i].length; j++) {
					var subId = wsManager.subscribe(this.props.pv[i][j], function (message) {
						return _this2.processUpdate(message);
					});
		...
		value: function componentWillUnmount() {
			...
			try {
				for (var _iterator = this.subIdList.keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	return ListBaseWidget;
}(_react2.default.Component);

exports.default = ListBaseWidget;
;
...
var _ListBaseWidget2 = require('./ListBaseWidget');

var _ListBaseWidget3 = _interopRequireDefault(_ListBaseWidget2);
...
var TableWidget = function (_ListBaseWidget) {
	_inherits(TableWidget, _ListBaseWidget);

	function TableWidget() {
		_classCallCheck(this, TableWidget);

		var _this = _possibleConstructorReturn(this, (TableWidget.__proto__ || Object.getPrototypeOf(TableWidget)).call(this));

		_this.virtualData = [];
		for (var i = 1; i <= 100; i++) {
			var row = ['c1', 'c2', 'c3', 'c4', 'c5', 'c6', 'c7', 'c8', 'c9', 'c10', 'c11', 'c12'];
			var rowData = {};
			...
			_this.virtualData.push(rowData);
		}

		_this.numUpdates = 0;
		_this.state = { data: _this.virtualData };
		return _this;
	}
	...
	_createClass(TableWidget, [{
		...
		key: 'processUpdate',
		value: function processUpdate(message) {
			if (message.type == 'connection') {
				var indexes = this.subIdList.get(message.id);

				if (message.connected) this.virtualData[indexes[0]]['c' + (indexes[1] + 1).toString()]['state'] = 'connected';else this.virtualData[indexes[0]]['c' + (indexes[1] + 1).toString()]['state'] = 'disconnected';
			}
		...
		value: function render() {
			return _react2.default.createElement(_reactTable2.default, { data: this.state.data,
				columns: [{
					Header: 'DRX Table',
					columns: [{ Header: "c01",
						accessor: "c1",
	...
	return TableWidget;
}(_ListBaseWidget3.default);

exports.default = TableWidget;

},{"./ListBaseWidget":2,"react":28,"react-table":20}],4:[function(require,module,exports){
'use strict';
...
var _TableWidget2 = _interopRequireDefault(_TableWidget);
...
var Combined = function (_React$Component) {
	_inherits(Combined, _React$Component);

	function Combined(props) {
		_classCallCheck(this, Combined);

		var _this = _possibleConstructorReturn(this, (Combined.__proto__ || Object.getPrototypeOf(Combined)).call(this));

		var pvs = [':bul:fpga:temp', ':bul:fpga:vccAux', ':bul:fpga:vccInt', ':bul:fpga:status', ':bul:atxInPower', ':bul:atxOutPower', ':bul:atx12V:iout', ':bul:atx3V3:iout', ':bul:atx3V3:vout', ':bul:atx5V:iout', ':bul:atx5VStby:iout', ':bul:atx:iin', ':bul:atx:vin', ':bul:atxFan:tacho', ':bul:chassisFan1:tacho', ':bul:chassisFan1:voltage', ':bul:chassisFan2:tacho', ':bul:chassisFan2:voltage', ':bul:chassisFan3:tacho', ':bul:chassisFan3:voltage', ':bul:chassisFan4:tacho', ':bul:chassisFan4:voltage', ':bul:chassisFan5:tacho', ':bul:chassisFan5:voltage', ':bul:chassisFan6:tacho', ':bul:chassisFan6:voltage', ':bul:chassisFan7:tacho', ':bul:chassisFan7:voltage', ':bul:chassisFan8:tacho', ':bul:chassisFan8:voltage', ':dig:tempLocal1:temp', ':bul:tempATX1:temp', ':bul:tempAux2:temp', ':dig:synthFreq', ':dig:tempLocal1:temp', ':dig:tempLocal2:temp', ':dig:tempLowerLeft:temp', ':dig:tempLowerRight:temp', ':dig:tempUpperLeft:temp', ':dig:tempUpperRight:temp', ':evt:driverUptime', ':dig:synthFreq', ':dig:adcTemp1:temp', ':dig:adcTemp2:temp', ':dig:adcTemp3:temp', ':dig:adcTemp4:temp', ':dig:adcTemp5:temp', ':dig:adcTemp6:temp', ':dig:adcTemp7:temp', ':dig:adcTemp8:temp', ':bul:chassisFan1:fanStatus', ':bul:chassisFan2:fanStatus', ':bul:chassisFan3:fanStatus', ':bul:chassisFan4:fanStatus', ':bul:chassisFan5:fanStatus', ':bul:chassisFan6:fanStatus', ':bul:chassisFan7:fanStatus', ':bul:chassisFan8:fanStatus', ':bul:atx:supplyStatus', ':bul:atxFan:fanStatus', ':LinkStatus10G1:status', ':LinkStatus10G2:status', ':LinkStatus10G3:status', ':LinkStatus10G4:status', ':LinkStatus10G5:status', ':LinkStatus10G6:status', ':LinkStatus10G7:status', ':LinkStatus10G8:status', ':LinkStatus10G9:status', ':LinkStatus10G10:status', ':evt:WF1:eventBase', ':evt:WF1:numCycles', ':evt:WF1:period', ':evt:WF1:pulseWidth', ':evt:WF1:resyncCount', ':evt:WF2:eventBase', ':evt:WF2:numCycles', ':evt:WF3:period', ':evt:WF4:pulseWidth', ':evt:WF5:resyncCount', ':dig:fans1:tacho', ':dig:fans2:tacho', ':dig:fans4:tacho', ':dig:fans4:tacho', ':S_linkStatus10G:calc', ':S_linkStatus10G:calc1', ':S_linkStatus10G:calc2', ':S_linkStatus10G:calc3', ':S_linkStatus10G:calc4', ':S_linkStatus10G:calc5', ':dig:fpga1:temp', ':dig:fpga2:temp', ':dig:fpga3:temp', ':dig:fpga4:temp', ':dig:optics1:temp', ':dig:optics2:temp', ':dig:optics3:temp', ':dig:optics4:temp', ':bul:tempFan1:temp', ':bul:tempFan2:temp'];

		var shelves = ['c01', 'c02', 'c03', 'c04', 'c05', 'c06', 'c07', 'c08', 'c09', 'c10', 'c11', 'c12'];
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'col-md-4' },
					_react2.default.createElement(_widgets.TextWidget, { label: 'My label:', pv: this.props.initial + ":" + this.props.subsystem + ":c01:bul:fpga:temp" })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-md-2 col-md-offset-6' },
					_react2.default.createElement(_widgets.LEDButton, { pv: this.props.initial + ":" + this.props.subsystem + ":F_startup:center_O" })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-md-12' },
					_react2.default.createElement(_TableWidget2.default, { pv: this.tablePV })
				)
			);
		}
	}]);
...
},{"./TableWidget":3,"./widgets":5,"jquery":11,"react":28}],5:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.TextWidget = exports.LEDButton = exports.LED = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _BaseWidget4 = require('./BaseWidget');

var _BaseWidget5 = _interopRequireDefault(_BaseWidget4);
...
var LED = exports.LED = function (_BaseWidget) {
	_inherits(LED, _BaseWidget);

	function LED() {
		_classCallCheck(this, LED);

		var _this = _possibleConstructorReturn(this, (LED.__proto__ || Object.getPrototypeOf(LED)).call(this));

		_this.state = { currentValue: "led-yellow" };
		return _this;
	}
	...
	_createClass(LED, [{
		...
		value: function processUpdate(message) {
			if (message.type == 'connection') {
				if (message.connected) this.setState({ currentValue: "led-blue" });

				return;
			}

			if (message.type == 'value') {
				if (message.value.value == 0) this.setState({ currentValue: "led-red" });else if (message.value.value == 1) this.setState({ currentValue: "led-green" });else this.setState({ currentValue: "led-blue" });
			}
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement('div', { className: this.state.currentValue });
		}
	}]);

	return LED;
}(_BaseWidget5.default);

var LEDButton = exports.LEDButton = function (_BaseWidget2) {
	_inherits(LEDButton, _BaseWidget2);

	function LEDButton() {
		_classCallCheck(this, LEDButton);

		var _this2 = _possibleConstructorReturn(this, (LEDButton.__proto__ || Object.getPrototypeOf(LEDButton)).call(this));
		...
		_this2.toggleSwitch = function (e) {
			...
			if (!_this2.state.currentValue) newValue = 1;

			wsManager.write(_this2.subId, 'int', newValue);
		};
	...
	_createClass(LEDButton, [{
		...
		value: function processUpdate(message) {
			...
			if (message.type == 'value') {
				if (message.value.value == 0) this.setState({ currentValue: false });else if (message.value.value == 1) this.setState({ currentValue: true });else this.setState({ currentValue: false });
			}
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(_reactToggleSwitch2.default, { onClick: this.toggleSwitch, on: this.state.currentValue, enabled: this.state.connected });
		}
	}]);
...
var TextWidget = exports.TextWidget = function (_BaseWidget3) {
	_inherits(TextWidget, _BaseWidget3);

	function TextWidget() {
		_classCallCheck(this, TextWidget);

		var _this3 = _possibleConstructorReturn(this, (TextWidget.__proto__ || Object.getPrototypeOf(TextWidget)).call(this));

		_this3.state = { currentValue: "" };
		return _this3;
	}
	...
	_createClass(TextWidget, [{
		key: 'processUpdate',
		value: function processUpdate(message) {
			if (message.type == 'value') this.setState({ currentValue: message.value.value });
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'text', className: 'col-md-6', value: this.state.currentValue })
			);
		}
	}]);
...
},{"./BaseWidget":1,"react":28,"react-toggle-switch":25}],6:[function(require,module,exports){
/*!
...
},{"./emptyFunction":7,"_process":13}],11:[function(require,module,exports){
/*!
...
},{"./lib/ReactPropTypesSecret":18,"fbjs/lib/emptyFunction":7,"fbjs/lib/invariant":9}],16:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":14,"./lib/ReactPropTypesSecret":18,"_process":13,"fbjs/lib/emptyFunction":7,"fbjs/lib/invariant":9,"fbjs/lib/warning":10,"object-assign":12}],17:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./pagination":23,"./utils":24,"classnames":6,"react":28}],20:[function(require,module,exports){
'use strict';
...
},{"./defaultProps":19,"./lifecycle":21,"./methods":22,"./utils":24,"classnames":6,"react":28}],21:[function(require,module,exports){
'use strict';
...
},{"./utils":24,"react":28}],23:[function(require,module,exports){
'use strict';
...
},{"classnames":6,"react":28}],24:[function(require,module,exports){
'use strict';
...
},{"classnames":6,"react":28}],25:[function(require,module,exports){
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});var _propTypes=require('prop-types'),_propTypes2=_interopRequireDefault(_propTypes),_react=require('react'),_react2=_interopRequireDefault(_react);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}var propTypes={on:_propTypes2.default.bool.isRequired,onClick:_propTypes2.default.func.isRequired,enabled:_propTypes2.default.bool,className:_propTypes2.default.string},defaultProps={enabled:!0,className:''};function Switch(a){var b=a.on,c=a.onClick,d=a.enabled,e=a.className,f=a.children,g=['switch',e,b?'on ':'',d?'':'disabled '].join(' ');return _react2.default.createElement('div',{className:g,onClick:function onClick(){return d?c():function(){}}},_react2.default.createElement('div',{className:'switch-toggle',children:f}))}Switch.propTypes=propTypes,Switch.defaultProps=defaultProps,exports.default=Switch;

},{"prop-types":17,"react":28}],26:[function(require,module,exports){
(function (process){
...
},{"_process":13,"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":9,"fbjs/lib/warning":10,"object-assign":12,"prop-types/checkPropTypes":14}],27:[function(require,module,exports){
/*
 React v16.0.0
...
},{"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":9,"object-assign":12}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":26,"./cjs/react.production.min.js":27,"_process":13}]},{},[4]);
